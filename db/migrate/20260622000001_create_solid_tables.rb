class CreateSolidTables < ActiveRecord::Migration[8.1]
  def change
    ...
    unless table_exists?(:solid_queue_blocked_executions) &&
           foreign_key_exists?(:solid_queue_blocked_executions, column: :job_id)
